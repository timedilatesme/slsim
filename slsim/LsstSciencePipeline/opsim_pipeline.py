...
def opsim_time_series_images_data(
    ...
    :param dec_list: a list of dec points (in degrees) from objects we want to collect
        observations for
    :param opsim_path: string, path to the opsim database. The opsim database can be
        downloaded from https://s3df.slac.stanford.edu/data/rubin/sim-data/
        under the sims_featureScheduler_runsX.X/baseline/ folder (replace
        X.X with the version of the opsim database you want to use).
