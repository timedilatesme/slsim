...
def opsim_time_series_images_data(
    ...
    (or other versions under this folder
    ...
    :param opsim_path: string, path to the opsim database The opsim
        ...
        data/sims_featureScheduler_runs5.3/baseline/ (or other versions
        under this folder https://s3df.slac.stanford.edu/data/rubin/sim-
        data/
